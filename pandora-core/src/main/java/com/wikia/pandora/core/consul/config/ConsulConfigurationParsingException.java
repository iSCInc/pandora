...
public class ConsulConfigurationParsingException extends ConfigurationException {
  static class Builder {
    ...
    ConsulConfigurationParsingException build(String path) {
      ...
      return hasCause()
             ? new ConsulConfigurationParsingException(path, sb.toString(), getCause())
             : new ConsulConfigurationParsingException(path, sb.toString());
    }
  ...
  /**
   * Create a mutable {@link Builder} to incrementally build a {@link ConsulConfigurationParsingException}.
   *
   * @param brief the brief summary of the error.
   *
   * @return a mutable builder to incrementally build a {@link ConsulConfigurationParsingException}.
   */
   ...
   */
  private ConsulConfigurationParsingException(String path, String msg) {
   ...
   */
  private ConsulConfigurationParsingException(String path, String msg, Throwable cause) {
